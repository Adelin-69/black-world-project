...
function GetDesignsLootIds()
{
	...
	if ($currentShip['baseShipId'] == 8) {
		...
		'ship_g-champion_design_g-champion_dusklight',
		'ship_spectrum_legend',
		'ship_g-champion_design_g-champion_lava',
		'ship_g-champion_design_g-champion_argon',
		'ship_g-champion_design_g-champion_lava',
		'ship_g-champion_design_g-champion_legend',
		'ship_g-champion_design_g-champion_albania',
		'ship_g-champion_design_g-champion_austria',
		'ship_g-champion_design_g-champion_belgium',
		'ship_g-champion_design_g-champion_croatia',
		'ship_g-champion_design_g-champion_czech-republic',
		'ship_g-champion_design_g-champion_england',
		'ship_g-champion_design_g-champion_france',
		'ship_g-champion_design_g-champion_germany',
		'ship_g-champion_design_g-champion_hungary',
		'ship_g-champion_design_g-champion_iceland',
		'ship_g-champion_design_g-champion_italy',
		'ship_g-champion_design_g-champion_poland',
		'ship_g-champion_design_g-champion_portugal',
		'ship_g-champion_design_g-champion_republic-of-ireland',
		'ship_g-champion_design_g-champion_romania',
		'ship_g-champion_design_g-champion_russia',
		'ship_g-champion_design_g-champion_spain',
		'ship_g-champion_design_g-champion_sweden',
		'ship_g-champion_design_g-champion_switzerland',
		'ship_g-champion_design_g-champion_ukraine',
		'ship_g-champion_design_g-champion_wales',
