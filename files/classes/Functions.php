...
class Functions {
    ...
    if ($json['inputs']['username']['validate'] === 'valid' && $json['inputs']['password']['validate'] === 'valid' && $json['inputs']['password_confirm']['validate'] === 'valid' && $json['inputs']['email']['validate'] === 'valid') {
      if ($mysqli->query('SELECT userId FROM player_accounts WHERE username = "'.$username.'"')->num_rows <= 0) {
        ...
        try {
          ...
          $json['message'] = 'You successfully registered.';
        ...
        $json['message'] = '<font color="red"><b>This username is already used!</b>';
      }
    }
    ...
    if ($statement->num_rows >= 1) {
      if (password_verify($password, $fetch['password'])) {
        if (json_decode($fetch['verification'])->verified) {
          ...
          $json['message'] = 'Account not verified. In order to activate it join our discord and write this: !verify '.$username.' '.json_decode($fetch['verification'])->hash;
        }
      } else {
      ...
      if (!in_array($player['factionId'], [1, 2, 3])) {
        ...
        if ($data->uridium >= 500000) {
          ...
          if ($notOnlineOrOnlineAndInEquipZone) {
            ...
            $json['message'] = '<font color="red"><b>Change of company is not possible. You must be on HomeBase!!</b>';
          }
        } else {
      ...
      if (($shop['items'][$itemId]['priceType'] == 'uridium' ? $data->uridium : $data->credits) >= $price) {
          ...
          if ($shop['items'][$itemId]['name'] == 'Apis') {
            if (!$items->apis) {
              ...
              $json['message'] = '<font color="red">You already have an '.$shop['items'][$itemId]['name'].' Drone.';
            }
            ...
            else if($shop['items'][$itemId]['name'] == 'Goliath'){
            if(in_array(10,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=10;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=8;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=49;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=69;
              $status = true;
            }
          }
            else if ($shop['items'][$itemId]['name'] == 'P.E.T') {
            if (!$items->pet) {
              $items->pet = true;
              $status = true;
            } else {
              $json['message'] = '<font color="red"><b>You already have an '.$shop['items'][$itemId]['name'].'!</b>';
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Zephyr'){
            if(in_array(231,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=231;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Berserker'){
            if(in_array(264,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=264;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Disruptor'){
            if(in_array(270,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=270;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Solaris'){
            if(in_array(275,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=275;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Surgeon'){
            if(in_array(156,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=156;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=70;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Pusat'){
            if(in_array(240,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=240;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Keres'){
            if(in_array(300,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=300;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'G-I-S-B'){
            if(in_array(294,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=294;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Phoenix'){
            if(in_array(1,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=1;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Yamato'){
            if(in_array(2,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=2;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=3;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Defcom'){
            if(in_array(4,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=4;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Liberator'){
            if(in_array(5,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=5;
              $status = true;
            }
          }
          else if($shop['items'][$itemId]['name'] == 'Piranha'){
            if(in_array(6,$items->ships))
            {
              $status = false;
              $json['message'] = '<font color="red"><b>YOU ALREADY HAVE THIS SHIP!</b>';
            }else
            {
              $items->ships[sizeof($items->ships)]=6;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=7;
              $status = true;
            }
          }
            ...
            {
              $items->ships[sizeof($items->ships)]=9;
              $status = true;
            }
          }
          else if ($shop['items'][$itemId]['name'] == 'Hull') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 2, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'DEFLECTOR') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 3, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'REPAIR') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 4, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'LASER_HIGH_RANGE') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 5, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'LASER_MID_RANGE') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 6, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'LASER_LOW_RANGE') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 7, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'ROCKET_MID_ACCURACY') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 8, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'ROCKET_LOW_ACCURACY') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 9, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'HONOR_BOOSTER') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 10, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['name'] == 'DAMAGE_BOOSTER') {

            $modules = json_decode($equipment['modules'],true);
            for($i=0;$i<$amount;$i++)
            {
                array_push($modules,array("Id" => sizeof($modules)+1, "Type" => 11, "InUse" => false));
            }
            $mysqli->query("UPDATE player_equipment SET modules = '".json_encode($modules)."' WHERE userId = ".$player['userId']."");
            
            $status = true;
          }else if ($shop['items'][$itemId]['category'] == 'boosters') {
            ...
            {
              $json['message'] = '<font color="red"> <b>ERROR: You are not connected to the spacemap!</b>';
            }
          ...
          if ($status) {
            ...
            try {
              ...
              if (Socket::Get('IsOnline', ['UserId' => $player['userId'], 'Return' => false])) {
                Socket::Send('BuyItem', ['UserId' => $player['userId'], 'ItemType' => $shop['items'][$itemId]['category'], 'DataType' => ($shop['items'][$itemId]['priceType'] == 'uridium' ? 0 : 1), 'price' => $price, 'Amount' => $amount, 'boost' => $shop['items'][$itemId]['boostId']]);
              }

              $json['message'] = '<font color="green"><b>'.$shop['items'][$itemId]['name'].' purchased! '.($amount != 0 ? '('.number_format($amount).')' : '').'</b>';
        ...
        $json['message'] = "<font color='red'>You don't have enough " . ($shop['items'][$itemId]['priceType'] == 'uridium' ? 'Uridium !' : 'Credits !');
      }
    } else {
      $json['message'] = 'Something went wrong!';
    }
  ...
  public static function ChangePilotName($newPilotName) {
    ...
    if (!preg_match('/^[A-Za-z0-9_.]+$/', $newPilotName)) {
      $json['inputs']['pilotName']['validate'] = 'invalid';
      $json['inputs']['pilotName']['error'] = 'Your pilot name is not valid.';
    }
    if ($json['inputs']['pilotName']['validate'] === 'valid') {
      $oldPilotNames = json_decode($player['oldPilotNames']);

      if (count($oldPilotNames) <= 0 || ((new DateTime(date('d.m.Y H:i:s')))->diff(new DateTime(end($oldPilotNames)->date))->days >= 0) || $player['rankId'] == 21) {
        if ($mysqli->query('SELECT userId FROM player_accounts WHERE pilotName = "'.$newPilotName.'"')->num_rows <= 0) {
          ...
          try {
            ...
            $json['message'] = '<font color="green"><b>Your Pilot name has been changed.</b>';
          ...
          $json['message'] = '<font color="red"><b>This Pilot name is already in use.</b>';
        }
      } else {
    ...
    if (array_key_exists($skill, $skills) && isset($skillPoints->{$skill}) && (!isset($skills[$skill]['baseSkill']) || (isset($skills[$skill]['baseSkill']) && $skills[$skills[$skill]['baseSkill']]['currentLevel'] == $skills[$skills[$skill]['baseSkill']]['maxLevel']))) {
      if ($items->skillTree->researchPoints >= 1 && $skillPoints->{$skill} < $skills[$skill]['maxLevel']) {
        ...
        try {
          ...
          $json['message'] = '<font color="red"><b>ERROR: Please try again later.</b>';
          $mysqli->rollback();
        }

        $mysqli->close();
      } else {
        $json['message'] = '<font color="red"><b>Something went wrong!</b>';
      }
    } else {
      $json['message'] = '<font color="red"><b>Something went wrong!</b>';
    }
  ...
  public static function GetShop() {
    return [
      'categories' => ['ships','boosters', 'drones', 'drones-design', 'lasers', 'extras', 'P.E.T'],
      'items' => [
        [
          'id' => 0,
          'category' => 'drones-design',
          'name' => 'Havoc',
          'price' => 100000,
          'priceType' => 'uridium',
          'amount' => true,
          'image' => 'do_img/global/items/drone/designs/havoc_200x200.png',
          'active' => true
        ],
        [
          'id' => 1,
          ...
          'priceType' => 'uridium',
          'amount' => true,
          'image' => 'do_img/global/items/drone/designs/hercules_200x200.png',
          'active' => true
        ],
        [
          'id' => 2,
        ...
        [
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\ship\goliath_100x100.png',
          'active' => true
        ],
        [
          'id' => 7,
        ...
        [
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\aegis_100x100.png',
          'active' => true
        ],
        [
          'id' => 9,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\citadel_100x100.png',
          'active' => true
        ],
        [
          'id' => 10,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\pet\pet10-15_top.png',
          'active' => true
        ],
        [
          'id' => 11,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\zephyr_100x100.png',
          'active' => true
        ],
        [
          'id' => 12,
        ...
        [
          ...
          'priceType' => 'uridium',
          'amount' => true,
          'image' => 'do_img/global/items/booster/booster_rep-b02_100x100.png',
          'active' => true,
          'boostId' => 11
        ],
        [
        ...
        [
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\berserker_100x100.png',
          'active' => true
        ],
        [
          'id' => 30,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\disruptor_100x100.png',
          'active' => true
        ],
        [
          'id' => 31,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\solaris_100x100.png',
          'active' => true
        ],
        [
          'id' => 32,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\ship\g-surgeon_100x100.png',
          'active' => true
        ],
        [
          'id' => 33,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\spearhead_100x100.png',
          'active' => true
        ],
        [
          'id' => 34,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\offert_100x100.png',
          'active' => false
        ],
        [
          'id' => 36,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\ship\keres_100x100.png',
          'active' => false
        ],
        [
          'id' => 37,
          ...
          'priceType' => 'Credits',
          'amount' => false,
          'image' => '\do_img\global\items\ship\phoenix_100x100.png',
          'active' => true
        ],
        [
          'id' => 38,
          ...
          'priceType' => 'credits',
          'amount' => false,
          'image' => '\do_img\global\items\ship\yamato_100x100.png',
          'active' => true
        ],
        [
          'id' => 39,
          ...
          'priceType' => 'credits',
          'amount' => false,
          'image' => '\do_img\global\items\ship\liberator_100x100.png',
          'active' => true
        ],
        [
          'id' => 40,
        ...
        [
          ...
          'priceType' => 'credits',
          'amount' => false,
          'image' => '\do_img\global\items\ship\defcom_100x100.png',
          'active' => true
        ],
        [
          'id' => 42,
          ...
          'priceType' => 'credits',
          'amount' => false,
          'image' => '\do_img\global\items\ship\piranha_100x100.png',
          'active' => true
        ],
        [
          'id' => 43,
          ...
          'priceType' => 'uridium',
          'amount' => false,
          'image' => '\do_img\global\items\ship\nostromo_100x100.png',
          'active' => true
        ],
        [
          'id' => 44,
  ...
  public static function ChangeVersion($version) {
    ...
    if ($version === 'false' || $version === 'true') {
      ...
      try {
        ...
        $json['message'] = '<font color="green"><b>Your version has been changed.</b>';

        $mysqli->commit();
      } catch (Exception $e) {
        $message = '<font color="red"><b>An error occurred. Please try again later.</b>';
        $mysqli->rollback();
      }
