<style>
  body {
    background-image: url(/img/background/background9.png);
    ...
    box-shadow: inset 0px 0px 25px 5px #004e66;
      ...
      <div id="main" class="index">
        <div class="container container-center">
          <div class="row form">
            <div class="col l6 s12 offset-l3">
              <div><img src="\img\background\4.png"></div>
              <div class="card white">
                <ul class="tabs blue tabs-fixed-width tab-demo z-depth-12" style="box-shadow: inset 0px 0px 3px 0px black;">
                ...
                <form id="login" method="post">
                  <div class="card-content white">
                    <div class="row">
                      ...
                      <div class="input-field col s12">
                        <button class="btn-large col s12">LOG IN</button>
                      </div>
                    </div>
                  </div>
                </form>
                ...
                <form id="register" method="post">
                  <div class="card-content white">
                    <div class="row">
                      ...
                      <div class="input-field col s12">
                        <i class="material-icons prefix">lock</i>
                        <input type="email" name="email" id="r-email" maxlength="260" required>
        ...
        <div style="position:absolute;top:0;right:0;">
          <a href="https://discord.gg/JgswyPV"><img src="https://cdn2.iconfinder.com/data/icons/gaming-platforms-squircle/250/discord_squircle-128.png" width="64" height="64"></img></a>
        </div>