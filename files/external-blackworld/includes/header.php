      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="<?php echo DOMAIN; ?>settings" style="margin-right: 20px">Settings</a></li>
            <li><a class="brand-logo" style="margin-left: 60px; font-size: 25px; color: red" href="/api/logout">Logout</a></li>
          </ul>
          </div>
        </div>
      </nav>
