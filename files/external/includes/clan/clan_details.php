...
?>
<div class="card white-text darken-4  padding-15">
  <?php if ($clan === NULL) { ?>
      ...
      <div class="row">
        <form id="send_clan_application" method="post">
          ...
          <div class="input-field center col s12">
            <button class="btn darken-3 waves-effect waves-light col s12 <?php echo ($pendingAlready || !$clan['recruiting'] ? 'disabled' : ''); ?>"style="color: white; background-color: green;">SEND</button>
          </div>
        </form>
      </div>
    </div>
