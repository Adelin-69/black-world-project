...
<div class="card white-text col s12 padding-15">
  <div class="row">
  ...
  <table id="clan-list" class="striped highlight">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo ($value['recruiting'] ? '<font color="green"><b>Recruiting</b>' : '<font color="red"><b>Closed</b>'); ?></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
  ...
  <ul class="pagination center">
    ...
    <li class="waves-effect waves-light" style="color: white; background-color: #002733;"><a href="<?php echo DOMAIN; ?>clan/join/<?php echo ($page_n === 0 ? 1 : $page_n); ?>"><i class="material-icons">chevron_left</i></a></li>
    <?php } ?>
    ...
    <li class="<?php echo ($page_n + 1 === $i ? 'active' : 'waves-effect waves-light'); ?>" style="color: white; background-color: #002733;"><a href="<?php echo DOMAIN; ?>clan/join/<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>

    <?php if (($page_n + 1) !== $number_of_pages) { ?>
      <li class="waves-effect waves-light"><a href="<?php echo DOMAIN; ?>clan/join/<?php echo $page_n + 2; ?>"><i class="material-icons" style="color: white; background-color: #002733;">chevron_right</i></a></li>

      <?php if ($number_of_pages > 5) { ?>
        <li class="waves-effect waves-light" style="color: white; background-color: #002733;"><a href="<?php echo DOMAIN; ?>clan/join/<?php echo $number_of_pages; ?>"><?php echo $number_of_pages; ?></a></li>
      <?php } ?>
    <?php } ?>
  </ul>
</div>
...
<div id="modal" class="modal darken-4 white-text">
  <div class="modal-content center">
    <h4>Withdraw your application</h4>
    <p>Would you really like to withdraw your application from %clan_name%?</p>
    <a id="withdraw" class="modal-close waves-effect waves-light btn darken-3" style="background-color: green">Ok</a>
    <a class="modal-close waves-effect waves-light btn darken-2" style="background-color: red">Cancel</a>
  </div>
</div>
