<?php $offerts = Functions::GetOfferts(); ?>
<style>
  body {
  ...
  outline: none;
  color: #fff;
  background: linear-gradient(to top, #003300 0%, #009933 100%);
  border: none;
  border-radius: 7px;
      ...
      <div id="main">
        <div class="container">
          <div class="row">
            ...
            <div class="col s12">
              <div class="card white-text black center padding-15" style="box-shadow: inset 0px 0px 5px 2px #00ccff;">
                <h5>Special Offert's</h5>

                <ul style="background-color: #282828;" class="tabs tabs-fixed-width tab-demo z-depth-3">
                <?php foreach ($offerts['categories'] as $value) { ?>
                ...
                <?php foreach ($offerts['categories'] as $value) { ?>
                  <div id="<?php echo $value; ?>">
                    <div class="row">
                      <?php foreach ($offerts['items'] as $value2) { if ($value2['category'] == $value && $value2['active']) { ?>
                      <div style="background-color: black;" class="col m4 s2">
                        <div id="item-<?php echo $value2['id']; ?>" style="background-color: #282828;" class="card">
                          <div class="clearfix">
                          ...
                          <div class="card-content">
                            <span class="card-title" style="font-weight: bold; font-size: 15px"><?php echo $value2['name']; ?></span>
          ...
          <div id="modal" class="modal white-text" style="background-color: black; box-shadow: inset 0px 0px 5px 5px #00ccff;">
