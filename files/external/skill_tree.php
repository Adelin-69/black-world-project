...
?>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <div class="card white-text center padding-15">
                ...
                <h6>LOG-DISKS: 
                  <span id="logdisks"><?php echo $skillTree->logdisks; ?></span> / REQUIRED: 
                  <span id="requiredLogdisks"><?php echo $requiredLogdisks; ?></span> > 
                  <button id="exchangeLogdisks" class="btn-small grey darken-3 waves-effect waves-light" <?php echo (($skillTree->logdisks < $requiredLogdisks) || ((array_sum((array)$skillPoints) + $skillTree->researchPoints) >= array_sum(array_column($skills, 'maxLevel'))) ? 'disabled' : '');?>>EXCHANGE</button> >> Research Points: 
                  <span id="researchPoints"><?php echo $skillTree->researchPoints; ?></span>
                </h6>
                <br>
      ...
      <div id="modal" class="modal darken-4 white-text">
        <div class="modal-content center">
          ...
          <a id="resetSkills" class="modal-close waves-effect waves-light btn darken-3" style="background-color: green">OK</a>
          <a class="modal-close waves-effect waves-light btn darken-2" style="background-color: red">Close</a>
        </div>
      </div>
